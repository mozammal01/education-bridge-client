...
import { Clock, Users, BadgeCheck, Star, Globe, BookOpen, User } from "lucide-react";
      ...
      >
        <div className="relative">
          <div className="relative h-48 bg-linear-to-b from-primary/10 to-primary/5 overflow-hidden">
            ...
            {isOwnProfile && (
              <div className="absolute top-3 left-3 bg-primary text-white text-xs px-2.5 py-1 rounded-full flex items-center gap-1 font-medium shadow-lg">
                <User className="h-3.5 w-3.5" />
                You
              </div>
            )}

            {tutor?.isVerified && !isOwnProfile && (
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4">
              ...
              <div className="flex items-center justify-between gap-2">
                <p className="text-white/90 text-sm line-clamp-1 flex-1">
                  {tutor?.headline?.split("|")[0]?.trim() || tutor?.bio?.substring(0, 50)}
                </p>
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <div className="grid grid-cols-3 gap-2 py-3 my-3 border-y border-gray-100">
            ...
            <div className="text-center border-x border-gray-100">
              ...
              <p className="text-sm font-semibold">{tutor?.totalStudents || 0}</p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-semibold">{tutor?.totalSessions || 0}</p>
