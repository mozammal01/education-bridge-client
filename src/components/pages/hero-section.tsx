        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative lg:pl-8">
            <div className="relative">
              ...
              {/* floating badges */}
              <div className="absolute -top-4 -right-4 bg-card border rounded-xl p-3 shadow-lg flex items-center gap-2">
              ...
              <div className="absolute -bottom-4 -left-4 bg-card border rounded-xl p-3 shadow-lg flex items-center gap-2">
